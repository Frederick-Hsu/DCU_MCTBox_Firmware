...
#define PWM_OUT_GENERATING_OPTION_H
	 ...
	 */
	#define PWM_OPTION_1TIMER_HIGH_LOW_TRANSFORMING		1
	#define PWM_OPTION_2TIMERS_ALTERNATE_SWTCHING		2
	
	#define PWM_OUT_GENRATE_OPTION1		PWM_OPTION_1TIMER_HIGH_LOW_TRANSFORMING
	#define PWM_OUT_GENRATE_OPTION2		PWM_OPTION_2TIMERS_ALTERNATE_SWTCHING
	
	#define PWM_OUT_GENERATE_OPTION		PWM_OUT_GENRATE_OPTION1
